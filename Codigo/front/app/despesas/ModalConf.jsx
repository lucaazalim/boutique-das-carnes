...
function ModalConf({open, setOpen, idDespesa}) {
    const apagarDespesa = async () => {
        try {
            const response = await fetch(
                `http://vps.azal.im:3001/despesas/${idDespesa}`,
                {
                    method: "DELETE",
                    redirect: "follow",
                }
        ...
        <div>
            ...
            >
                <div className="bg-white p-5 rounded-md w-1/4">
                    ...
                    <p className="mt-5">Deseja realmente apagar esta despesa?</p>
